...
import { PixelData, TypedArray } from 'https://esm.sh/v135/@tensorflow/tfjs-core@4.15.0/dist/index.d.ts';
import { Texture, TextureConfig } from './tex_util.d.ts';
import { WebGL1DisjointQueryTimerExtension, WebGL2DisjointQueryTimerExtension, WebGLParallelCompilationExtension } from './webgl_types.d.ts';
