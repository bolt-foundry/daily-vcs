...
import './flags_webgl.d.ts';
import { BackendValues, DataId, DataStorage, DataToGPUWebGLOption, DataType, GPUData, KernelBackend, MemoryInfo, Rank, RecursiveArray, Tensor, Tensor2D, TensorBuffer, TensorInfo, TimingInfo, WebGLData } from 'https://esm.sh/v135/@tensorflow/tfjs-core@4.15.0/dist/index.d.ts';
import { GPGPUContext } from './gpgpu_context.d.ts';
import * as gpgpu_math from './gpgpu_math.d.ts';
import { GPGPUProgram } from './gpgpu_math.d.ts';
import { TextureData } from './tex_util.d.ts';
import { TextureManager } from './texture_manager.d.ts';
