/* esm.sh - esbuild bundle(@tensorflow/tfjs-core@4.15.0/dist/backends/where_impl) denonext production */
import{buffer as i}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/ops/buffer.js";function c(n,o){let e=[];for(let t=0;t<o.length;t++)o[t]&&e.push(t);let r=i(n,"int32"),f=i([e.length,n.length],"int32");for(let t=0;t<e.length;t++){let s=r.indexToLoc(e[t]),l=t*n.length;f.values.set(s,l)}return f.toTensor()}export{c as whereImpl};
