/* esm.sh - esbuild bundle(@tensorflow/tfjs-core@4.15.0/dist/ops/image/transform) denonext production */
import{ENGINE as c}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/engine.js";import{Transform as p}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/kernel_names.js";import{convertToTensor as s}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/tensor_util_env.js";import*as n from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/util.js";import{op as g}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/ops/operation.js";function h(a,m,e="nearest",f="constant",i=0,t){let o=s(a,"image","transform","float32"),r=s(m,"transforms","transform","float32");n.assert(o.rank===4,()=>`Error in transform: image must be rank 4,but got rank ${o.rank}.`),n.assert(r.rank===2&&(r.shape[0]===o.shape[0]||r.shape[0]===1)&&r.shape[1]===8,()=>"Error in transform: Input transform should be batch x 8 or 1 x 8"),n.assert(t==null||t.length===2,()=>`Error in transform: outputShape must be [height, width] or null, but got ${t}.`);let l={image:o,transforms:r},u={interpolation:e,fillMode:f,fillValue:i,outputShape:t};return c.runKernel(p,l,u)}var x=g({transform_:h});export{x as transform};
