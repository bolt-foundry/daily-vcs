/* esm.sh - esbuild bundle(@tensorflow/tfjs-core@4.15.0/dist/ops/sparse/sparse_segment_sum) denonext production */
import{ENGINE as i}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/engine.js";import{SparseSegmentSum as d}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/kernel_names.js";import{convertToTensor as s}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/tensor_util_env.js";import{op as p}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/ops/operation.js";function u(t,o,a){let n=s(t,"data","sparseSegmentSum"),e=s(o,"indices","sparseSegmentSum","int32"),r=s(a,"segmentIds","sparseSegmentSum","int32");if(n.rank<1)throw new Error("Data should be at least 1 dimensional but received scalar");if(e.rank!==1)throw new Error(`Indices should be Tensor1D but received shape
