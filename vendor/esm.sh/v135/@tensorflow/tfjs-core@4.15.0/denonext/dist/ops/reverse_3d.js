/* esm.sh - esbuild bundle(@tensorflow/tfjs-core@4.15.0/dist/ops/reverse_3d) denonext production */
import{convertToTensor as n}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/tensor_util_env.js";import*as e from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/util.js";import{op as s}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/ops/operation.js";import{reverse as m}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/ops/reverse.js";function i(o,t){let r=n(o,"x","reverse");return e.assert(r.rank===3,()=>`Error in reverse3D: x must be rank 3 but got rank ${r.rank}.`),m(r,t)}var v=s({reverse3d_:i});export{v as reverse3d};
