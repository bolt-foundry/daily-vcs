/* esm.sh - esbuild bundle(@tensorflow/tfjs-core@4.15.0/dist/ops/sparse/sparse_segment_mean) denonext production */
import{ENGINE as m}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/engine.js";import{SparseSegmentMean as d}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/kernel_names.js";import{convertToTensor as r}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/tensor_util_env.js";import{op as p}from"/v135/@tensorflow/tfjs-core@4.15.0/denonext/dist/ops/operation.js";function c(t,a,o){let s=r(t,"data","sparseSegmentMean"),e=r(a,"indices","sparseSegmentMean","int32"),n=r(o,"segmentIds","sparseSegmentMean","int32");if(s.rank<1)throw new Error("Data should be at least 1 dimensional but received scalar");if(e.rank!==1)throw new Error(`Indices should be Tensor1D but received shape
