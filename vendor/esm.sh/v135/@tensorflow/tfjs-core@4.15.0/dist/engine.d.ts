...
import { BackendTimingInfo, DataMover, KernelBackend } from './backends/backend.d.ts';
import { Environment } from './environment.d.ts';
import { NamedAttrMap } from './kernel_registry.d.ts';
import { TensorInfo } from './tensor_info.d.ts';
import { TapeNode } from './tape.d.ts';
import { DataToGPUOptions, GPUData, Tensor, TensorTracker, Variable } from './tensor.d.ts';
import { DataId } from './tensor_info.d.ts';
import { GradSaveFunc, NamedTensorMap, NamedVariableMap, TensorContainer } from './tensor_types.d.ts';
import { BackendValues, DataType, DataValues } from './types.d.ts';
/**
