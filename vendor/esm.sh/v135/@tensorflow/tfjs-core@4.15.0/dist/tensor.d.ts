...
/// <reference path="https://esm.sh/v135/@webgpu/types@0.1.38/dist/index.d.ts" />
import { DataId, TensorInfo } from './tensor_info.d.ts';
import { ArrayMap, BackendValues, DataType, DataTypeMap, DataValues, NumericDataType, Rank, ShapeMap, SingleValueMap } from './types.d.ts';
