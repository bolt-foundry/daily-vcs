...
import { NamedGradientMap } from './tape.d.ts';
import { Tensor } from './tensor.d.ts';
import { TensorInfo } from './tensor_info.d.ts';
import { RecursiveArray } from './types.d.ts';
type AttributeValue = number | number[] | boolean | boolean[] | string | string[] | NamedAttrMap;
...
export type GradFunc = (dy: Tensor | Tensor[], saved: Tensor[], attrs: NamedAttrMap) => NamedGradientMap;
