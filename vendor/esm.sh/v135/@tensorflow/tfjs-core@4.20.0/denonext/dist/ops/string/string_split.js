/* esm.sh - esbuild bundle(@tensorflow/tfjs-core@4.20.0/dist/ops/string/string_split) denonext production */
import{ENGINE as u}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/engine.js";import{StringSplit as a}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/kernel_names.js";import{convertToTensor as e}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/tensor_util_env.js";import{op as c}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/ops/operation.js";function m(n,o,s=!0){let r=e(n,"input","stringSplit","string"),t=e(o,"delimiter","stringSplit","string");if(r.rank!==1)throw new Error(`Input should be Tensor1D but received shape ${r.shape}`);if(t.rank!==0)throw new Error(`Delimiter should be a scalar but received shape ${t.shape}`);let p={skipEmpty:s},l={input:r,delimiter:t},i=u.runKernel(a,l,p);return{indices:i[0],values:i[1],shape:i[2]}}var S=c({stringSplit_:m});export{S as stringSplit};
