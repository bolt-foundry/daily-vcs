/* esm.sh - esbuild bundle(@tensorflow/tfjs-core@4.20.0/dist/ops/sparse/sparse_reshape_util) denonext production */
import{sizeFromShape as s}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/util.js";function p(e,t){return`only one output dimension may be -1, not both ${e} and ${t}`}function o(e,t){return`size ${e} must be non-negative, not ${t}`}function i(){return"reshape cannot infer the missing input size for an empty tensor unless all specified input sizes are non-zero"}function a(e,t){let r=s(e),n=s(t);return`Input to reshape is a SparseTensor with ${r}
