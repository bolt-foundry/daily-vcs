/* esm.sh - esbuild bundle(@tensorflow/tfjs-core@4.20.0/dist/ops/segment_util) denonext production */
import{nearestDivisor as a}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/util.js";import{PARALLELIZE_THRESHOLD as w}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/ops/reduce_util.js";function g(o,p){let r=!1,t;for(o<=w?(t=o,r=!0):t=a(o,Math.floor(Math.sqrt(o)));!r;)t>p||t===o?r=!0:t=a(o,t+1);return t}function O(o,p,r){let t=[],h=o.length;for(let s=0;s<h;s++)s!==p?t.push(o[s]):t.push(r);return t}function c(o,p,r,t){let h=p.shape.length,s=o.shape.length;if(t!==0&&(t<-h||t>h))throw new Error(`Expect batchDims in the range of [-${h}, ${h}], but got ${t}`);if(t<0&&(t+=h),t>s)throw new Error(`batchDims (${t}) must be less than rank(x) (
