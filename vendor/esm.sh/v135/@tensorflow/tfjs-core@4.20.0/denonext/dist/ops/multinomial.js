/* esm.sh - esbuild bundle(@tensorflow/tfjs-core@4.20.0/dist/ops/multinomial) denonext production */
import{ENGINE as c}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/engine.js";import{Multinomial as f}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/kernel_names.js";import{convertToTensor as p}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/tensor_util_env.js";import{op as g}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/ops/operation.js";import{reshape as s}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/ops/reshape.js";function b(m,l,r,e=!1){let o=p(m,"logits","multinomial"),n=o.size,t=o.rank;if(n<2)throw new Error(`Error in multinomial: you need at least 2 outcomes, but got ${n}.`);if(t>2)throw new Error(`Rank of probabilities must be 1 or 2, but is ${t}`);r=r||Math.random();let a={logits:t===1?s(o,[1,-1]):o},u={numSamples:l,seed:r,normalized:e},i=c.runKernel(f,a,u);return t===1?s(i,[i.size]):i}var D=g({multinomial_:b});export{D as multinomial};
