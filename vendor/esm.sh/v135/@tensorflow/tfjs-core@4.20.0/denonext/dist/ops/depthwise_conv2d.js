/* esm.sh - esbuild bundle(@tensorflow/tfjs-core@4.20.0/dist/ops/depthwise_conv2d) denonext production */
import{ENGINE as w}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/engine.js";import{DepthwiseConv2dNative as $}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/kernel_names.js";import{convertToTensor as l}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/tensor_util_env.js";import*as s from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/util.js";import*as f from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/ops/conv_util.js";import{op as b}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/ops/operation.js";import{reshape as u}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/ops/reshape.js";function x(m,d,c,o,i="NHWC",v=[1,1],a){let e=l(m,"x","depthwiseConv2d","float32"),n=l(d,"filter","depthwiseConv2d","float32"),t=e,p=!1;e.rank===3&&(p=!0,t=u(e,[1,e.shape[0],e.shape[1],e.shape[2]])),s.assert(t.rank===4,()=>`Error in depthwiseConv2d: input must be rank 4, but got rank ${t.rank}.`),s.assert(n.rank===4,()=>`Error in depthwiseConv2d: filter must be rank 4, but got rank ${n.rank}.`);let h=i==="NHWC"?t.shape[3]:t.shape[1];s.assert(h===n.shape[2],()=>`Error in depthwiseConv2d: number of input channels (${h}) must match the inChannels dimension in filter ${n.shape[2]}.`),f.checkPadOnDimRoundingMode("depthwiseConv2d",o,a);let C={x:t,filter:n},k={strides:c,pad:o,dataFormat:i,dilations:v,dimRoundingMode:a},r=w.runKernel($,C,k);return p?u(r,[r.shape[1],r.shape[2],r.shape[3]]):r}var g=b({depthwiseConv2d_:x});export{g as depthwiseConv2d};
