/* esm.sh - esbuild bundle(@tensorflow/tfjs-core@4.20.0/dist/ops/image/non_max_suppression_with_score) denonext production */
import{ENGINE as S}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/engine.js";import{NonMaxSuppressionV5 as I}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/kernel_names.js";import{convertToTensor as i}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/tensor_util_env.js";import{nonMaxSuppSanityCheck as M}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/ops/nonmax_util.js";import{op as N}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/ops/operation.js";function f(m,u,n,s=.5,r=Number.NEGATIVE_INFINITY,e=0){let t=i(m,"boxes","nonMaxSuppression"),p=i(u,"scores","nonMaxSuppression"),o=M(t,p,n,s,r,e);n=o.maxOutputSize,s=o.iouThreshold,r=o.scoreThreshold,e=o.softNmsSigma;let x={boxes:t,scores:p},a={maxOutputSize:n,iouThreshold:s,scoreThreshold:r,softNmsSigma:e},c=S.runKernel(I,x,a);return{selectedIndices:c[0],selectedScores:c[1]}}var V=N({nonMaxSuppressionWithScore_:f});export{V as nonMaxSuppressionWithScore};
