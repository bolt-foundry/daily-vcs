/* esm.sh - esbuild bundle(@tensorflow/tfjs-core@4.20.0/dist/tensor_format) denonext production */
import{computeStrides as $,isString as k,rightPad as z,sizeFromShape as N}from"/v135/@tensorflow/tfjs-core@4.20.0/denonext/dist/util.js";var I=20,p=3,j=7;function w(n,e,t,i){let f=$(e),g=O(n,e,t,f),S=e.length,r=A(n,e,t,f,g),c=["Tensor"];return i&&(c.push(`  dtype: ${t}`),c.push(`  rank: ${S}`),c.push(`  shape: [${e}]`),c.push("  values:")),c.push(r.map(a=>"    "+a).join(`
`)),c.join(`
