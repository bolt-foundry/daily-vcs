...
import { FormData, type Blob, type FilePropertyBag, type FsReadStream } from "./_shims/index.d.ts";
import { MultipartBody } from "./_shims/MultipartBody.d.ts";
export { fileFromPath } from "./_shims/index.d.ts";
