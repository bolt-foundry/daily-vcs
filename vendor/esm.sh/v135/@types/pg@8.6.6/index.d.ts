...
import events = require('https://esm.sh/v135/@types/node@18.16.19/events.d.ts');
import stream = require('https://esm.sh/v135/@types/node@18.16.19/stream.d.ts');
import pgTypes = require('https://esm.sh/v135/@types/pg-types@2.2.0/index.d.ts');
import { NoticeMessage } from 'https://esm.sh/v135/pg-protocol@1.6.0/dist/messages.d.ts';

import { ConnectionOptions } from 'https://esm.sh/v135/@types/node@18.16.19/tls.d.ts';
...
import * as Pg from './index.d.ts';

export const native: typeof Pg | null;

export { DatabaseError } from 'https://esm.sh/v135/pg-protocol@1.6.0/dist/index.d.ts';
