import { NormalizationOperation, NormalizationSplitOperation } from "./NormalizationNode.d.ts";
import { ReaderFragment, ReaderInlineDataFragment } from "./ReaderNode.d.ts";
import { OperationType } from "./RelayRuntimeTypes.d.ts";
