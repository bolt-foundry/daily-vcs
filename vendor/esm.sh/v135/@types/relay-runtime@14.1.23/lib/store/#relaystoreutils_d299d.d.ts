import { NormalizationArgument, NormalizationField, NormalizationHandle } from "../util/NormalizationNode.d.ts";
import { ReaderArgument, ReaderField } from "../util/ReaderNode.d.ts";
