import { NormalizationSelectableNode } from "../util/NormalizationNode.d.ts";
import { ReaderFragment } from "../util/ReaderNode.d.ts";
import { DataID, Variables } from "../util/RelayRuntimeTypes.d.ts";
import {
