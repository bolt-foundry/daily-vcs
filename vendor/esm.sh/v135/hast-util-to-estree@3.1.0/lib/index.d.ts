...
export type ExpressionStatement = import('https://esm.sh/v135/@types/estree@1.0.5/index.d.ts').ExpressionStatement;
...
export type Options = import('./state.d.ts').Options;
