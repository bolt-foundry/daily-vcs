import type {Program} from 'https://esm.sh/v135/@types/estree-jsx@1.0.3/index.d.ts'
...
import type {Data, Node} from 'https://esm.sh/v135/@types/unist@3.0.2/index.d.ts'
import type {Tag} from './lib/index.d.ts'

// Expose JavaScript API.
export {mdxJsxFromMarkdown, mdxJsxToMarkdown} from './lib/index.d.ts'

// Expose options.
export type {ToMarkdownOptions} from './lib/index.d.ts'
...
declare module 'https://esm.sh/v135/mdast-util-from-markdown@2.0.0/index.d.ts' {
...
declare module 'https://esm.sh/v135/mdast-util-to-markdown@2.1.0/index.d.ts' {
