...
} from './lib/footer.d.ts'
export type {Handler, Handlers, Options, State} from './lib/state.d.ts'

// Expose JS API.
export {handlers as defaultHandlers} from './lib/handlers/index.d.ts'
export {
  defaultFootnoteBackContent,
  defaultFootnoteBackLabel
} from './lib/footer.d.ts'
export {toHast} from './lib/index.d.ts'
