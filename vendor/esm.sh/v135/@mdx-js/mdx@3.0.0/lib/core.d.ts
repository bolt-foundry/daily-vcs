...
export type Program = import('https://esm.sh/v135/@types/estree-jsx@1.0.3/index.d.ts').Program;
export type ElementAttributeNameCase = import('https://esm.sh/v135/hast-util-to-estree@3.1.0/index.d.ts').ElementAttributeNameCase;
export type StylePropertyNameCase = import('https://esm.sh/v135/hast-util-to-estree@3.1.0/index.d.ts').StylePropertyNameCase;
export type Root = import('https://esm.sh/v135/@types/mdast@4.0.3/index.d.ts').Root;
export type RemarkRehypeOptions = import('https://esm.sh/v135/remark-rehype@11.0.0/index.d.ts').Options;
export type SourceMapGenerator = typeof import('https://esm.sh/v135/source-map@0.7.4/source-map.d.ts').SourceMapGenerator;
export type PluggableList = import('https://esm.sh/v135/unified@11.0.4/index.d.ts').PluggableList;
export type Processor = import('https://esm.sh/v135/unified@11.0.4/index.d.ts').Processor<Root, Program, Program, Program, string>;
/**
...
export type ProcessorOptions = {
     ...
     * (JavaScript)
     */
    recmaPlugins?: import("https://esm.sh/v135/unified@11.0.4/index.d.ts").PluggableList | null | undefined;
    /**
     * List of remark plugins (optional).
     */
    remarkPlugins?: import("https://esm.sh/v135/unified@11.0.4/index.d.ts").PluggableList | null | undefined;
    /**
     * List of rehype plugins (optional).
     */
    rehypePlugins?: import("https://esm.sh/v135/unified@11.0.4/index.d.ts").PluggableList | null | undefined;
    /**
