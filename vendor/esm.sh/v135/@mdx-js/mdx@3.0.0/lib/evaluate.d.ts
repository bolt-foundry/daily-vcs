...
export type MDXModule = import('https://esm.sh/v135/@types/mdx@2.0.10/types.d.ts').MDXModule;
export type Compatible = import('https://esm.sh/v135/vfile@6.0.1/index.d.ts').Compatible;
export type EvaluateOptions = import('./util/resolve-evaluate-options.d.ts').EvaluateOptions;
