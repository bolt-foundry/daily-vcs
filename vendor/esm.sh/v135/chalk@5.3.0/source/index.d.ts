...
import {ModifierName, ForegroundColorName, BackgroundColorName, ColorName} from './vendor/ansi-styles/index.d.ts';
import {ColorInfo, ColorSupportLevel} from './vendor/supports-color/index.d.ts';
...
// } from '#ansi-styles';
} from './vendor/ansi-styles/index.d.ts';
...
export {
	...
	ColorSupportLevel,
// } from '#supports-color';
} from './vendor/supports-color/index.d.ts';
