...
import { GaxiosOptions, GaxiosResponse } from 'https://esm.sh/v135/gaxios@6.1.1/build/src/index.d.ts';
import * as stream from 'https://esm.sh/v135/@types/node@18.16.19/stream.d.ts';
import { DefaultTransporter, Transporter } from '../transporters.d.ts';
import { Compute } from './computeclient.d.ts';
import { CredentialBody, ImpersonatedJWTInput, JWTInput } from './credentials.d.ts';
import { IdTokenClient } from './idtokenclient.d.ts';
import { GCPEnv } from './envDetect.d.ts';
import { JWT, JWTOptions } from './jwtclient.d.ts';
import { Headers, OAuth2ClientOptions } from './oauth2client.d.ts';
import { UserRefreshClient, UserRefreshClientOptions } from './refreshclient.d.ts';
import { Impersonated, ImpersonatedOptions } from './impersonated.d.ts';
import { ExternalAccountClientOptions } from './externalclient.d.ts';
import { BaseExternalAccountClient } from './baseexternalclient.d.ts';
import { AuthClient, AuthClientOptions } from './authclient.d.ts';
import { ExternalAccountAuthorizedUserClient } from './externalAccountAuthorizedUserClient.d.ts';
/**
