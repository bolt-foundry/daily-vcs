...
import { GaxiosError, GaxiosOptions, GaxiosPromise, GaxiosResponse } from 'https://esm.sh/v135/gaxios@6.1.1/build/src/index.d.ts';
import * as querystring from 'https://esm.sh/v135/@types/node@18.16.19/querystring.d.ts';
import { JwkCertificate } from '../crypto/crypto.d.ts';
import { BodyResponseCallback } from '../transporters.d.ts';
import { AuthClient, AuthClientOptions } from './authclient.d.ts';
import { Credentials } from './credentials.d.ts';
import { LoginTicket } from './loginticket.d.ts';
/**
