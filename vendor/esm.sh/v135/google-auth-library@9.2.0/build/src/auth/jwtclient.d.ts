...
import { GoogleToken } from 'https://esm.sh/v135/gtoken@7.0.1/build/src/index.d.ts';
import * as stream from 'https://esm.sh/v135/@types/node@18.16.19/stream.d.ts';
import { CredentialBody, Credentials, JWTInput } from './credentials.d.ts';
import { IdTokenProvider } from './idtokenclient.d.ts';
import { GetTokenResponse, OAuth2Client, OAuth2ClientOptions, RequestMetadataResponse } from './oauth2client.d.ts';
