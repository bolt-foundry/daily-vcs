import { GraphQLNamedType } from 'https://esm.sh/v135/graphql@16.8.1/index.d.ts';
import type { DynamicFieldDefs, SchemaConfig } from './builder.d.ts';
import type { SourceTypings } from './definitions/_types.d.ts';
import type { NexusOutputFieldConfig } from './definitions/definitionBlocks.d.ts';
import type { NexusInputObjectTypeConfig } from './definitions/inputObjectType.d.ts';
import type { NexusInterfaceTypeConfig } from './definitions/interfaceType.d.ts';
import type { NexusObjectTypeConfig } from './definitions/objectType.d.ts';
