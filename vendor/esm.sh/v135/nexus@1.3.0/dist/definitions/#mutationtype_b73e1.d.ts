import { NexusObjectTypeConfig } from './objectType.d.ts';
/**
 ...
 *   for more detail.
 */
export declare function mutationType(config: Omit<NexusObjectTypeConfig<'Mutation'>, 'name'>): import("./objectType.d.ts").NexusObjectTypeDef<"Mutation">;
