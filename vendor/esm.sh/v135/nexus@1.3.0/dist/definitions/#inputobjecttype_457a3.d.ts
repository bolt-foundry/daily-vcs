import { GraphQLInputObjectTypeConfig } from 'https://esm.sh/v135/graphql@16.8.1/index.d.ts';
import { NexusArgDef, NexusAsArgConfig } from './args.d.ts';
import type { InputDefinitionBlock } from './definitionBlocks.d.ts';
import { Maybe, NonNullConfig } from './_types.d.ts';
