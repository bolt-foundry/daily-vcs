import { GraphQLNamedType, GraphQLScalarTypeConfig } from 'https://esm.sh/v135/graphql@16.8.1/index.d.ts';
import type { AllNexusInputTypeDefs, AllNexusOutputTypeDefs } from '../core.d.ts';
import { GraphQLNamedOutputType, Maybe, SourceTypingDef } from './_types.d.ts';
