import { GraphQLObjectType } from 'https://esm.sh/v135/graphql@16.8.1/index.d.ts';
import type { InterfaceFieldsFor } from '../typegenTypeHelpers.d.ts';
import { OutputDefinitionBlock, OutputDefinitionBuilder } from './definitionBlocks.d.ts';
import type { FieldModification, FieldModificationDef, Implemented } from './interfaceType.d.ts';
import { AbstractTypes, Maybe, NonNullConfig, SourceTypingDef } from './_types.d.ts';
