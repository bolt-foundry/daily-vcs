...
import type { ArgsValue, GetGen, MaybePromise, MaybePromiseDeep, ResultValue } from '../typegenTypeHelpers.d.ts';
import type { IsEqual } from '../typeHelpersInternal.d.ts';
import type { CommonOutputFieldConfig } from './definitionBlocks.d.ts';
import type { AllNexusOutputTypeDefs } from './wrapping.d.ts';
 ...
 */
export declare function subscriptionType(config: SubscriptionTypeParams): import("./objectType.d.ts").NexusObjectTypeDef<string>;
