import type { AllOutputTypesPossible } from '../typegenTypeHelpers.d.ts';
import type { ObjectDefinitionBlock } from './objectType.d.ts';
import type { IsSubscriptionType, SubscriptionBuilder } from './subscriptionType.d.ts';
export interface NexusExtendTypeConfig<TypeName extends string> {
     ...
     */
    definition(t: IsSubscriptionType<TypeName> extends true ? SubscriptionBuilder : ObjectDefinitionBlock<TypeName>): void;
}
