import type { GraphQLScalarTypeConfig } from 'https://esm.sh/v135/graphql@16.8.1/index.d.ts';
import type { AllInputTypes, GetGen2 } from '../typegenTypeHelpers.d.ts';
import type { AllNexusArgsDefs, AllNexusInputTypeDefs } from './wrapping.d.ts';
import { Maybe } from './_types.d.ts';
