import type { GraphQLFieldConfig, GraphQLFieldResolver, GraphQLInputFieldConfig } from 'https://esm.sh/v135/graphql@16.8.1/index.d.ts';
import type { AllInputTypes, FieldResolver, GetGen, GetGen3, HasGen3, NeedsResolver } from '../typegenTypeHelpers.d.ts';
import type { ArgsRecord } from './args.d.ts';
import type { NexusMetaType } from './nexusMeta.d.ts';
import type { AllNexusInputTypeDefs, AllNexusOutputTypeDefs, NexusWrapKind } from './wrapping.d.ts';
import type { Maybe } from './_types.d.ts';
