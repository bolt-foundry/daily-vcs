import { GraphQLInterfaceTypeConfig } from 'https://esm.sh/v135/graphql@16.8.1/index.d.ts';
import type { FieldResolver, GetGen, InterfaceFieldsFor, ModificationType } from '../typegenTypeHelpers.d.ts';
