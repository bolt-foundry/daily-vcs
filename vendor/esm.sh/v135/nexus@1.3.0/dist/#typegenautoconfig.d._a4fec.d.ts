import { GraphQLNamedType, GraphQLSchema } from 'https://esm.sh/v135/graphql@16.8.1/index.d.ts';
import type { TypegenInfo } from './builder.d.ts';
import type { TypingImport } from './definitions/_types.d.ts';
