import { GraphQLSchema } from 'https://esm.sh/v135/graphql@16.8.1/index.d.ts';
import type { BuilderConfigInput, TypegenInfo } from './builder.d.ts';
import type { ConfiguredTypegen } from './core.d.ts';
import type { NexusGraphQLSchema } from './definitions/_types.d.ts';
