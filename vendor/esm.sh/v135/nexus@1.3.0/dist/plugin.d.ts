import type { GraphQLFieldResolver, GraphQLInterfaceType, GraphQLResolveInfo, GraphQLSchema } from 'https://esm.sh/v135/graphql@16.8.1/index.d.ts';
import type { PluginBuilderLens, SchemaConfig } from './builder.d.ts';
import { Maybe, NexusGraphQLFieldConfig, NexusGraphQLInterfaceTypeConfig, NexusGraphQLObjectTypeConfig, Omit } from './definitions/_types.d.ts';
import type { InputDefinitionBlock, NexusOutputFieldDef, NexusInputFieldDef } from './definitions/definitionBlocks.d.ts';
import type { NexusInputObjectTypeConfig } from './definitions/inputObjectType.d.ts';
import type { NexusObjectTypeConfig, ObjectDefinitionBlock } from './definitions/objectType.d.ts';
import type { NexusSchemaExtension } from './extensions.d.ts';
import { PrintedGenTyping, PrintedGenTypingImport } from './utils.d.ts';
import type { NexusFinalArgConfig } from './definitions/args.d.ts';
import type { UnwrapPromise } from './typeHelpersInternal.d.ts';
...
export declare namespace plugin {
    var completeValue: typeof import("./plugin.d.ts").completeValue;
}
