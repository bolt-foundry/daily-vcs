import { GraphQLNullableType, GraphQLResolveInfo } from 'https://esm.sh/v135/graphql@16.8.1/index.d.ts';
import type { GraphQLPossibleOutputs } from '../definitions/_types.d.ts';
import type { AllOutputTypes, GetGen, GetGen2 } from '../typegenTypeHelpers.d.ts';
...
export declare const nullabilityGuardPlugin: (pluginConfig: NullabilityGuardConfig) => import("../plugin.d.ts").NexusPlugin;
