import { GraphQLFieldResolver, GraphQLResolveInfo } from 'https://esm.sh/v135/graphql@16.8.1/index.d.ts';
import { ArgsRecord } from '../definitions/args.d.ts';
import type { CommonFieldConfig, FieldOutConfig } from '../definitions/definitionBlocks.d.ts';
import { NexusNonNullDef } from '../definitions/nonNull.d.ts';
import { NexusNullDef } from '../definitions/nullable.d.ts';
import { ObjectDefinitionBlock } from '../definitions/objectType.d.ts';
import { AllNexusNamedOutputTypeDefs } from '../definitions/wrapping.d.ts';
import type { NonNullConfig } from '../definitions/_types.d.ts';
import type { ArgsValue, FieldTypeName, GetGen, MaybePromise, MaybePromiseDeep, ResultValue, SourceValue } from '../typegenTypeHelpers.d.ts';
...
export declare const connectionPlugin: {
    (connectionPluginConfig?: ConnectionPluginConfig | undefined): import("../plugin.d.ts").NexusPlugin;
