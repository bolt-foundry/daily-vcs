import type { RunnableInterface, RunnableIOSchema, Node, Edge } from "./types.d.ts";
export { Node, Edge };
export declare class Graph {
    ...
    extend(graph: Graph, prefix?: string): ({
        id: string;
        data: RunnableIOSchema | RunnableInterface<any, any, import("./types.d.ts").RunnableConfig>;
    } | undefined)[];
    trimFirstNode(): void;
    trimLastNode(): void;
    drawMermaid(params?: {
