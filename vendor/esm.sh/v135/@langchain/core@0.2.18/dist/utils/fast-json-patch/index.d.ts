...
export * from "./src/duplex.d.ts";
export { PatchError as JsonPatchError, _deepClone as deepClone, escapePathComponent, unescapePathComponent, } from "./src/helpers.d.ts";
/**
 * Default export for backwards compat
 */
import * as core from "./src/core.d.ts";
import { PatchError as JsonPatchError, _deepClone as deepClone, escapePathComponent, unescapePathComponent } from "./src/helpers.d.ts";
