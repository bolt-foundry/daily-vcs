...
export interface NexusGenInterfaces {
  Actor:
    | core.Discriminate<"BfOrganization", "required">
    | core.Discriminate<"BfPerson", "required">;
  BfCurrentViewer:
    | core.Discriminate<"BfCurrentViewerAccessToken", "required">
    | core.Discriminate<"BfCurrentViewerAnon", "required">;
  BfNode:
    | core.Discriminate<"BfAccount", "required">
    | core.Discriminate<"BfOrganization", "required">
    | core.Discriminate<"BfPerson", "required">;
  IBfGraphQLNode: any;
}
