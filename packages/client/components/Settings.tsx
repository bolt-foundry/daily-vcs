...
import { textStyles } from "packages/bfDs/const.tsx";
import { Tabs } from "packages/bfDs/Tabs.tsx";
import { Input } from "packages/bfDs/Input.tsx";
// import { SettingsQuery_me$key } from "packages/__generated__/SettingsQuery_me.graphql.ts";
...
import { PasswordResetForm } from "packages/client/pages/ResetPasswordPage.tsx";
import { SettingsProjectTab } from "packages/client/components/SettingsProjectTab.tsx";
...
export function Settings({ person$key }: Props) {
