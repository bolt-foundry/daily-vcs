...
// import { DownloadClip_clip$key } from "packages/__generated__/DownloadClip_clip.graphql.ts";
...
//   queueRender,
//   registerEvents,
// } from "packages/lib/renderQueue.ts";
...
export const DownloadClip: React.FC<DownloadClipProps> = (
  {
    asButton = false,
    videoUrl,
    clip$key,
