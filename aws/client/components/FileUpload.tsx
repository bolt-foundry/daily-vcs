...
import { uploadFileToS3 } from "aws/lib/uploadToS3.ts";
import Button from "aws/client/ui_components/Button.tsx";
import FilePreview from "aws/client/components/FilePreview.tsx";
...
import { FileUploadCreateNewProjectMutation$data } from "aws/__generated__/FileUploadCreateNewProjectMutation.graphql.ts";
import { FileUpload_project$key } from "aws/__generated__/FileUpload_project.graphql.ts";
...
import environment from "aws/client/relay/environment.ts";
import {
  addFile,
  refreshFiles,
} from "aws/client/relay/localResolvers/ProjectResolver.ts";
import languages from "aws/client/lib/languages.ts";
