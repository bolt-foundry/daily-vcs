...
import { ProjectList_me$key } from "aws/__generated__/ProjectList_me.graphql.ts";
import {
  ProjectListItem_Project$key,
} from "aws/__generated__/ProjectListItem_Project.graphql.ts";
...
const styles: Record<string, React.CSSProperties> = {
  ...
  itemHovered: {
    backgroundColor: "var(--itemDarkHovered)",
  },
  listStyle: {},
  title: {
    overflow: "hidden",
...
function ProjectList({ person$key }: Props) {
